...
grep 'ONELOGIN_PYTHON_AWS_ASSUME_ROLE_DIR' "${CONFIG_ENVS_FILE}" &>/dev/null || echo "export ONELOGIN_PYTHON_AWS_ASSUME_ROLE_DIR=${ONELOGIN_PYTHON_AWS_ASSUME_ROLE_DIR}" >> "${CONFIG_ENVS_FILE}"

pushd "${ONELOGIN_PYTHON_AWS_ASSUME_ROLE_DIR}" &>/dev/null
